...
typedef enum {
    ...
    /* Numpad */
    DISPLAY_KEY_KP_ENTER    = 0xFF8D,
    DISPLAY_KEY_KP_MULTIPLY = 0xFFAA,
    DISPLAY_KEY_KP_ADD      = 0xFFAB,
    DISPLAY_KEY_KP_SUBTRACT = 0xFFAD,
    DISPLAY_KEY_KP_DECIMAL  = 0xFFAE,
    DISPLAY_KEY_KP_DIVIDE   = 0xFFAF,
    DISPLAY_KEY_KP_0        = 0xFFB0,
    DISPLAY_KEY_KP_1        = 0xFFB1,
    DISPLAY_KEY_KP_2        = 0xFFB2,
    DISPLAY_KEY_KP_3        = 0xFFB3,
    DISPLAY_KEY_KP_4        = 0xFFB4,
    DISPLAY_KEY_KP_5        = 0xFFB5,
    DISPLAY_KEY_KP_6        = 0xFFB6,
    DISPLAY_KEY_KP_7        = 0xFFB7,
    DISPLAY_KEY_KP_8        = 0xFFB8,
    DISPLAY_KEY_KP_9        = 0xFFB9,
    /* Function keys F1-F12 */
    DISPLAY_KEY_F1          = 0xFFBE,
    DISPLAY_KEY_F2          = 0xFFBF,
    DISPLAY_KEY_F3          = 0xFFC0,
    DISPLAY_KEY_F4          = 0xFFC1,
    DISPLAY_KEY_F5          = 0xFFC2,
    DISPLAY_KEY_F6          = 0xFFC3,
    DISPLAY_KEY_F7          = 0xFFC4,
    DISPLAY_KEY_F8          = 0xFFC5,
    DISPLAY_KEY_F9          = 0xFFC6,
    DISPLAY_KEY_F10         = 0xFFC7,
    DISPLAY_KEY_F11         = 0xFFC8,
